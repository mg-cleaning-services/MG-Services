...
export default function RequestService() {
  ...
  return (
    <main className="min-h-screen bg-[#F9FAF9] text-[#1A1A1A]">
      {/* SIMPLE REQUEST HEADER */}
      <header className="border-b border-[#2E7D32]/10 bg-white">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8">
          <Link to="/" className="flex items-center gap-3">
            ...
            <span className="hidden text-sm font-light uppercase tracking-widest text-[#1A1A1A]/50 sm:inline">
              Cleaning Melbourne
            </span>
          </Link>
          ...
          <Link
            to="/"
            className="flex items-center gap-2 text-sm font-medium text-[#1A1A1A]/60 transition-colors hover:text-[#2E7D32]"
          >
